...
public enum UserCode implements ResultCode {
    ...
    PASSWORD_UPDATE_ERROR("20121", "密码修改异常"),
    DISABLED_FAILED("20122", "禁用用户失败"),
    REFRESH_TOKEN_INVALID("20123", "refresh token 过期,请重新登录"),
    LOGOUT_ERROR("20124", "退出登录异常"),
    USER_DOES_NOT_EXIST("20125", "用户不存在"),
    LIST_USER_PERMISSION_ERROR("20126", "查询用户权限列表异常"),
    LIST_USER_ROLE_ERROR("20127", "查询用户角色列表异常"),
